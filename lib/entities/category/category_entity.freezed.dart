...
mixin _$CategoryEntity {
  ...
  String get idDivisi => throw _privateConstructorUsedError;
...
abstract class $CategoryEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String idDivisi, String title});
}
    ...
    return _then(_value.copyWith(
      id: null == id
          ...
          : id // ignore: cast_nullable_to_non_nullable
              as String,
      idDivisi: null == idDivisi
          ? _value.idDivisi
          : idDivisi // ignore: cast_nullable_to_non_nullable
              as String,
      title: null == title
          ? _value.title
...
class _$_CategoryEntity implements _CategoryEntity {
  const _$_CategoryEntity(
      {required this.id, required this.idDivisi, required this.title});
  ...
  @override
  String toString() {
    return 'CategoryEntity(id: $id, idDivisi: $idDivisi, title: $title)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.idDivisi, idDivisi) ||
                other.idDivisi == idDivisi) &&
            (identical(other.title, title) || other.title == title));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, idDivisi, title);
...
abstract class _CategoryEntity implements CategoryEntity {
  const factory _CategoryEntity(
      ...
      required final String idDivisi,
